...
def remove_participant(activity_name: str, email: str):
    ...
    activity = activities[activity_name]
    filtered_participants = [participant for participant in activity["participants"] if participant != email]

    if len(filtered_participants) == len(activity["participants"]):
        raise HTTPException(status_code=404, detail="Participant not found")

    activity["participants"] = filtered_participants
